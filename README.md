...
# ML Project — Предсказание высокого рейтинга рецепта по его характеристикам
...
**Датасет:** [[Название и источник датасета]](https://www.kaggle.com/datasets/shuyangli94/food-com-recipes-and-user-interactions?resource=download) - food.com recipes and user interactions
